          ...
          {step === 'email' && (
            <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
              ...
              {usePassword && (
                <div>
                  ...
                  <div style={{ textAlign: 'right', marginTop: 6 }}>
                    <Link href="/auth/reset-password" style={{ color: '#64748b', fontSize: '0.75rem', textDecoration: 'none' }}>
                      Forgot password?
                    </Link>
                  </div>
                </div>
              ...
              <button onClick={() => { setUsePassword(!usePassword); setError('') }}
                style={{ background: 'none', border: 'none', color: '#475569', fontSize: '0.8rem', cursor: 'pointer', padding: 0, textAlign: 'center' }}>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
              <div>
                ...
                <input type="text" value={otp}
                  ...
                  style={{ width: '100%', background: 'rgba(15,23,42,0.8)', border: '1px solid rgba(148,163,184,0.12)', borderRadius: 12, padding: '14px 16px', color: '#f1f5f9', fontSize: '1.6rem', textAlign: 'center', letterSpacing: '0.4em', fontFamily: 'monospace', outline: 'none' }} />
              </div>
              {error && <p style={{ color: '#f87171', fontSize: '0.85rem', background: 'rgba(248,113,113,0.08)', border: '1px solid rgba(248,113,113,0.2)', borderRadius: 8, padding: '8px 12px' }}>{error}</p>}
